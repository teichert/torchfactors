...
from torchfactors.einsum import log_dot, my_align_to

# from torchfactors.einsum import (MultiEquation, compile_equation,
#                                  compile_obj_equation, )
...
#     from_str, = cast(MultiEquation,
#                      compile_equation('ij,jk,kl->jl', force_multi=True)).equations
#     i, j, k, el = [object() for _ in range(4)]
